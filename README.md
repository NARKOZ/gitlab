...
Gitlab.configure do |config|
  config.base_uri       = 'https://api.example.net' # uri of the server (required)
  config.endpoint       = nil                       # endpoint, default to 'api/v2' (optional)
...
```ruby
# set an API base uri
Gitlab.base_uri = 'http://example.net'
# => "http://example.net"
...
g = Gitlab.client(:endpoint => nil, :base_uri => 'https://api.example.com', :private_token => 'qEsq1pt6HJPaNciie3MG')
# => #<Gitlab::Client:0x00000001e62408 @base_uri="https://api.example.com", @endpoint=nil, @private_token="qEsq1pt6HJPaNciie3MG", @user_agent="Gitlab Ruby Gem 2.0.0">
