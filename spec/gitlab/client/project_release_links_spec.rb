...
RSpec.describe Gitlab::Client do
  describe '.project_release_links' do
    before do
      ...
      @project_release_links = described_class.project_release_links(3, 'v0.1')
    end
    ...
    it "returns a paginated response of project's release links" do
      expect(@project_release_links).to be_a Gitlab::Client::PaginatedResponse
    end
  end
  ...
  describe '.project_release_link' do
    before do
      ...
      @project_release_link = described_class.project_release_link(3, 'v0.1', 1)
    end
  ...
  describe '.create_project_release_link' do
    before do
      ...
      @project_release_link = described_class.create_project_release_link(5, 'v0.1', name: 'awesome-v0.2.dmg', url: 'http://192.168.10.15:3000')
    end
  ...
  describe '.update_project_release_link' do
    before do
      ...
      @project_release_link = described_class.update_project_release_link(5, 'v0.1', 1, url: 'http://192.168.10.15:3000')
    end
  ...
  describe '.delete_project_release_link' do
    before do
      ...
      @project_release_link = described_class.delete_project_release_link(3, 'v0.1', 1)
    end
