...
RSpec.describe Gitlab::Client do
  describe '.epics' do
    ...
    it 'returns a paginated response of groups' do
      expect(@epics).to be_a Gitlab::Client::PaginatedResponse
    end
  end
  ...
  describe '.create_epic' do
    before do
      ...
      described_class.create_epic(1, 'foo', description: 'bar')
    end
  ...
  describe '.edit_epic' do
    before do
      ...
      described_class.edit_epic(1, 2, title: 'mepmep')
    end
  ...
  describe '.delete_epic' do
    before do
      ...
      described_class.delete_epic(1, 2)
    end
