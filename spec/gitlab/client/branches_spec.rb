...
describe Gitlab::Client do
  ...
  describe ".protect_branch" do
    before do
      stub_put("/projects/3/protected_branches", "branch")
    end
    ...
    context "without options" do
      ...
      it "updates the correct resource" do
        expect(a_put("/projects/3/protected_branches")).to have_been_made
      end
    ...
    context "with options" do
      ...
      it "updates the correct resource with the correct options" do
        expect(
          a_put("/projects/3/protected_branches").with(body: { developers_can_push: 'true' })
        ).to have_been_made
      end
    end
  end
  ...
  describe ".unprotect_branch" do
    before do
      stub_put("/projects/3/protected_branches/api","branch")
      @branch = Gitlab.unprotect_branch(3, "api")
    end

    it "gets the correct resource" do
      expect(a_put("/projects/3/protected_branches/api")).to have_been_made
    end
