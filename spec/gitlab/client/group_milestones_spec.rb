...
RSpec.describe Gitlab::Client do
  describe '.group_milestones' do
    before do
      ...
      @milestones = described_class.group_milestones(3)
    end
  ...
  describe '.group_milestone' do
    before do
      ...
      @milestone = described_class.group_milestone(3, 1)
    end
  ...
  describe '.create_group_milestone' do
    before do
      ...
      @milestone = described_class.create_group_milestone(3, 'title')
    end
  ...
  describe '.edit_group_milestone' do
    before do
      ...
      @milestone = described_class.edit_group_milestone(3, 33, title: 'title')
    end
  ...
  describe '.group_milestone_issues' do
    before do
      ...
      @milestone_issues = described_class.group_milestone_issues(3, 1)
    end
  ...
  describe '.group_milestone_merge_requests' do
    before do
      ...
      @milestone_merge_requests = described_class.group_milestone_merge_requests(3, 1)
    end
