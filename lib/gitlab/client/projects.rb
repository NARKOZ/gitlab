...
class Gitlab::Client
  ...
  module Projects
    ...
    # @see https://docs.gitlab.com/ce/api/project_badges.html#list-all-badges-of-a-project
    #
    # @example
    #   Gitlab.project_badges(42)
    #   Gitlab.project_badges('gitlab', { order_by: 'last_activity_at' })
    #   Gitlab.project_badges('gitlab', { order_by: 'name', sort: 'asc' })
    #
    # @param  [Integer, String] user_id The ID or username of the user.
    # @param  [Hash] options A customizable set of options.
    # @option options [String] :per_page Number of projects to return per page
    # @option options [String] :page The page to retrieve
    # @return [Array<Gitlab::ObjectifiedHash>]
    def project_badges(project, options = {})
      get("/projects/#{url_encode project}/badges", query: options)
    end
    
    # Get information of a project badge
    # @see https://docs.gitlab.com/ce/api/project_badges.html#get-a-badge-of-a-project
    #
    # @example
    #   Gitlab.project_badge(42, 2)
    #   Gitlab.project_badge('media-center/transcoder', 3)
    #
    # @param  [Integer, String] project The ID or path of a project.  
    # @param  [Integer] id The badge ID. 
    # @return [Gitlab::ObjectifiedHash] Information about the edited bagde. 
    def project_badge(project, id)
    ...
    #
    # @example
    #   Gitlab.add_project_badge('gitlab', 'https://gitlab.com/gitlab-org/gitlab-ce/commits/master', 'https://shields.io/my/badge1')
    #
    # @param  [Integer, String] project The ID or path of a project.
    ...
    def add_project_badge(project, link_url, image_url)
    ...
    #
    # @example
    #   Gitlab.edit_project_badge(42, 2)
    #   Gitlab.edit_project_badge(42, 2, { link_url: 'https://gitlab.com/gitlab-org/gitlab-ce/commits/master' })
    #   Gitlab.edit_project_badge('project-name', 2, { link_url: 'https://gitlab.com/gitlab-org/gitlab-ce/commits/master', image_url: 'https://shields.io/my/badge1' })
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The badge ID.
    # @param  [Hash] options A customizable set of options
    ...
    # (Any provided options will be passed to Gitlab. See {https://docs.gitlab.com/ce/api/project_badges.html#edit-a-badge-of-a-project Gitlab docs} for all valid options)
    #
    # @return [Gitlab::ObjectifiedHash] Information about the edited bagde.
    def edit_project_badge(project, id, options = {})
      put("/projects/#{url_encode project}/badges/#{id}", body: options)
    end
    
    # Remove a badge from a project.
    # @see https://docs.gitlab.com/ce/api/project_badges.html#remove-a-badge-from-a-project
    #
    # @example
    #   Gitlab.remove_project_badge(42, 2)
    #   Gitlab.remove_project_badge('gitlab-org/gitlab-ce', 2)
    #
    # @param  [Integer, String] project The ID or path of a project.
    # @param  [Integer] id The badge ID.
    # @return [Gitlab::ObjectifiedHash] Empty hash.
    def remove_project_badge(project, id)
