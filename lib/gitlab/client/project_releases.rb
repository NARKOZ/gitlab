...
class Gitlab::Client
  ...
  module ProjectReleases
    ...
    #
    # @example
    #   Gitlab::Client.project_releases(5)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Client::ObjectifiedHash>] Paginated list of Releases, sorted by created_at.
    ...
    #
    # @example
    #   Gitlab::Client.project_release(5, 'v0.1')
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name  The tag where the release will be created from..
    # @return [Gitlab::Client::ObjectifiedHash] Information about the release
    ...
    #
    # @example
    #   Gitlab::Client.create_project_release(5, { name: 'New Release', tag_name: 'v0.3', description: 'Super nice release' })
    #   Gitlab::Client.create_project_release(5, { name: 'New Release', tag_name: 'v0.3', description: 'Super nice release', assets: { links: [{ name: 'hoge', url: 'https://google.com' }] } })
    #
    # @param [Integer, String] project The ID or name of a project.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about the created release.
    ...
    #
    # @example
    #   Gitlab::Client.update_project_release(5, 'v0.3', { name: 'New Release', description: 'Super nice release' })
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name  The tag where the release will be created from.
    # @param [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about the updated release.
    ...
    #
    # @example
    #   Gitlab::Client.delete_project_release(5, 'v0.3')
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [String] tag_name  The tag where the release will be created from.
    # @return [Gitlab::Client::ObjectifiedHash] Information about the deleted release.
