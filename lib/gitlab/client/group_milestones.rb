...
class Gitlab::Client
  ...
  module GroupMilestones
    ...
    #
    # @example
    #   Gitlab::Client.group_milestones(5)
    #
    ...
    #
    # @example
    #   Gitlab::Client.group_milestone(5, 36)
    #
    # @param  [Integer, String] id The ID or name of a group.
    ...
    #
    # @example
    #   Gitlab::Client.create_group_milestone(5, 'v1.0')
    #
    # @param  [Integer, String] id The ID or name of a group.
    ...
    #
    # @example
    #   Gitlab::Client.edit_group_milestone(5, 2, { state_event: 'activate' })
    #
    # @param  [Integer, String] id The ID or name of a group.
    # @param  [Integer] milestone_id The ID of a milestone.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Client.group_milestone_issues(5, 2)
    #
    # @param  [Integer, String] id The ID or name of a group.
    ...
    #
    # @example
    #   Gitlab::Client.group_milestone_merge_requests(5, 2)
    #
