...
class Gitlab::Client
  ...
  module Snippets
    ...
    #
    # @example
    #   Gitlab::Client.create_snippet(42, { title: 'REST', file_name: 'api.rb', code: 'some code', visibility: 'public'})
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Client.edit_snippet(42, 34, { file_name: 'README.txt' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a snippet.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Client.delete_snippet(2, 14)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a snippet.
    # @return [Gitlab::Client::ObjectifiedHash] Information about deleted snippet.
    ...
    #
    # @example
    #   Gitlab::Client.snippet_content(2, 14)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a snippet.
    # @return [Gitlab::Client::ObjectifiedHash] Information about deleted snippet.
