...
class Gitlab::Client
  ...
  module PipelineTriggers
    ...
    #
    # @example
    #   Gitlab::Client.triggers(5)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Client::ObjectifiedHash>] The list of triggers.
    ...
    #
    # @example
    #   Gitlab::Client.trigger(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] trigger_id The trigger ID.
    # @return [Gitlab::Client::ObjectifiedHash] The trigger.
    ...
    #
    # @example
    #   Gitlab::Client.create_trigger(5, description: "my description")
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] description The trigger name
    # @return [Gitlab::Client::ObjectifiedHash] The created trigger.
    ...
    #
    # @example
    #   Gitlab::Client.update_trigger(5, 1, description: "my description")
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] trigger_id The trigger ID.
    # @param [Hash] options A customizable set of options.
    # @option options [String] :description The trigger name.
    # @return [Gitlab::Client::ObjectifiedHash] The updated trigger.
    ...
    #
    # @example
    #   Gitlab::Client.trigger_take_ownership(5, 1)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] trigger_id The trigger ID.
    # @return [Gitlab::Client::ObjectifiedHash] The updated trigger.
    ...
    #
    # @example
    #   Gitlab::Client.remove_trigger(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] trigger_id The trigger ID.
    ...
    #
    # @example
    #   Gitlab::Client.run_trigger(5, '7b9148c158980bbd9bcea92c17522d', 'master')
    #   Gitlab::Client.run_trigger(5, '7b9148c158980bbd9bcea92c17522d', 'master', { variable1: "value", variable2: "value2" })
    #
    # @see https://docs.gitlab.com/ce/ci/triggers/README.html
    #
