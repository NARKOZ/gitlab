...
class Gitlab::Client
  ...
  module Tags
    ...
    #
    # @example
    #   Gitlab::Client.create_tag(42, 'new_tag', 'master')
    #   Gitlab::Client.create_tag(42, 'v1.0', 'master', 'Release 1.0')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.tag(3, 'api')
    #   Gitlab::Client.repo_tag(5, 'master')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.delete_tag(3, 'api')
    #   Gitlab::Client.repo_delete_tag(5, 'master')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.create_release(3, '1.0.0', 'This is ready for production')
    #   Gitlab::Client.repo_create_release(5, '1.0.0', 'This is ready for production')
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.update_release(3, '1.0.0', 'This is even more ready for production')
    #   Gitlab::Client.repo_update_release(5, '1.0.0', 'This is even more ready for production')
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] tag The name of the new tag.
    # @param  [String] description Release notes with markdown support
