...
class Gitlab::Client
  ...
  module GroupBadges
    ...
    #
    # @example
    #   Gitlab::Client.group_badges(5)
    #   Gitlab::Client.group_badges(5, 'Coverage')
    #
    ...
    # @return [Array<Gitlab::Client::ObjectifiedHash>] List of all badges of a group
    ...
    #
    # @example
    #   Gitlab::Client.group_badge(5, 42)
    #
    # @param [Integer, String] group(required) The ID or URL-encoded path of the group owned by the authenticated user.
    ...
    #
    # @example
    #   Gitlab::Client.add_group_badge(5, { link_url: 'https://abc.com/gitlab/gitlab-ce/commits/master', image_url: 'https://shields.io/my/badge1' })
    #
    # @param [Integer, String] group(required) The ID or URL-encoded path of the group owned by the authenticated user.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about the added group badge.
    ...
    #
    # @example
    #   Gitlab::Client.edit_group_badge(5, 1, { link_url: 'https://abc.com/gitlab/gitlab-ce/commits/master', image_url: 'https://shields.io/my/badge1' })
    #
    # @param [Integer, String] group(required) The ID or URL-encoded path of the group owned by the authenticated user.
    # @param [Integer] badge_id(required) The badge ID.
    # @param [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about the updated group badge.
    ...
    #
    # @example
    #   Gitlab::Client.remove_group_badge(5, 42)
    #
    # @param [Integer, String] group(required) The ID or URL-encoded path of the group owned by the authenticated user.
    # @param [Integer] badge_id(required) The badge ID.
    ...
    #
    # @example
    #   Gitlab::Client.preview_group_badge(3, 'https://abc.com/gitlab/gitlab-ce/commits/master', 'https://shields.io/my/badge1')
    #
    # @param [Integer, String] group(required) The ID or URL-encoded path of the group owned by the authenticated user.
