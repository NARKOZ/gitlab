...
class Gitlab::Client
  ...
  module ResourceLabelEvents
    ...
    #
    # @example
    #   Gitlab::Client.issue_label_events(5, 42)
    #
    ...
    #
    # @example
    #   Gitlab::Client.issue_label_event(5, 42, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] issue_iid The IID of an issue.
    ...
    #
    # @example
    #   Gitlab::Client.epic_label_events(5, 42)
    #
    ...
    #
    # @example
    #   Gitlab::Client.epic_label_event(5, 42, 1)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] epic_id The ID of an epic.
    # @param  [Integer] id The ID of a label event.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_label_events(5, 42)
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_label_event(5, 42, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
