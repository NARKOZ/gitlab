...
class Gitlab::Client
  ...
  module Groups
    ...
    #   Gitlab::Client.groups({ per_page: 40, page: 2 })
    #
    ...
    #
    # @example
    #   Gitlab::Client.create_group('new-group', 'group-path')
    #   Gitlab::Client.create_group('gitlab', 'gitlab-path', { description: 'New Gitlab project' })
    #
    # @param  [String] name The name of a group.
    # @param  [String] path The path of a group.
    # @return [Gitlab::Client::ObjectifiedHash] Information about created group.
    ...
    #
    # @example
    #   Gitlab::Client.delete_group(42)
    # @param  [Integer] id The ID of a group
    # @return [Gitlab::Client::ObjectifiedHash] Information about the deleted group.
    def delete_group(id)
    ...
    #
    # @example
    #   Gitlab::Client.group_members(1)
    #   Gitlab::Client.group_members(1, { per_page: 40 })
    #
    # @param  [Integer] id The ID of a group.
    # @param  [Hash] options A customizable set of options.
    # @option options [Integer] :page The page number.
    ...
    #
    # @example
    #   Gitlab::Client.group_billable_members(1)
    #   Gitlab::Client.group_billable_members(1, { per_page: 40 })
    #
    # @param  [Integer] id The ID of a group.
    # @param  [Hash] options A customizable set of options.
    # @option options [Integer] :page The page number.
    ...
    #
    # @example
    #   Gitlab::Client.group_merge_requests(5)
    #
    ...
    #
    # @example
    #   Gitlab::Client.add_group_member(1, 2, 40)
    #
    ...
    #
    # @example
    #   Gitlab::Client.edit_group_member(1, 2, 40)
    #
    # @param  [Integer] team_id The group id of member to edit.
    # @param  [Integer] user_id The user id of the user to edit.
    # @param  [Integer] access_level Project access level.
    # @return [Gitlab::Client::ObjectifiedHash] Information about edited team member.
    ...
    #
    # @example
    #   Gitlab::Client.remove_group_member(1, 2)
    #
    ...
    #
    # @example
    #   Gitlab::Client.transfer_project_to_group(3, 50)
    #
    # @param  [Integer] id The ID of a group.
    ...
    #
    # @example
    #   Gitlab::Client.group_search('gitlab')
    #
    ...
    # @example
    #   Gitlab::Client.group_projects(1)
    #
    # @param [Integer] id The ID of a group
    # @return [Array<Gitlab::Client::ObjectifiedHash>] List of projects under a group
    ...
    # @example
    #   Gitlab::Client.group_subgroups(1)
    #
    # @param [Integer] id the ID of a group
    # @param [Hash] options A customizable set of options.
    ...
    # @return [Array<Gitlab::Client::ObjectifiedHash>] List of subgroups under a group
    ...
    #
    # @example
    #   Gitlab::Client.edit_group(42)
    #   Gitlab::Client.edit_group(42, { name: 'Group Name' })
    #
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about the edited group.
    ...
    #
    # @example
    #   Gitlab::Client.sync_ldap_group(1)
    #
    ...
    #
    # @example
    #   Gitlab::Client.add_ldap_group_links(1, 'all', 50, 'ldap')
    #
    # @param  [Integer] id The ID of a group
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about added ldap group link
    ...
    #
    # @example
    #   Gitlab::Client.delete_ldap_group_links(1, 'all')
    #
    # @param  [Integer] id The ID of a group
    # @param  [String] cn The CN of a LDAP group
    # @return [Gitlab::Client::ObjectifiedHash] Empty hash
    ...
    #
    # @example
    #   Gitlab::Client.group_custom_attributes(2)
    #
    ...
    #
    # @example
    #   Gitlab::Client.group_custom_attribute('key', 2)
    #
    ...
    #
    # @example
    #   Gitlab::Client.delete_group_custom_attribute('somekey', 2)
    #
