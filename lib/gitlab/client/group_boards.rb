...
class Gitlab::Client
  ...
  module GroupBoards
    ...
    #
    # @example
    #   Gitlab::Client.group_boards(5)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @return [Array<Gitlab::Client::ObjectifiedHash>] List of issue boards of the group
    ...
    #
    # @example
    #   Gitlab::Client.group_board(5, 1)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] id The ID of the issue board.
    # @return [Gitlab::Client::ObjectifiedHash] Returns information about a group issue board
    ...
    #
    # @example
    #   Gitlab::Client.create_group_board(5, 'Documentcloud')
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] name The name of the new board.
    # @return [Gitlab::Client::ObjectifiedHash] Information about created group issue board.
    ...
    #
    # @example
    #   Gitlab::Client.edit_group_board(5, 1, { name: 'DocumentCloud2' })
    #   Gitlab::Client.edit_group_board(5, 1, { name: 'DocumentCloud2', assignee_id: 3 })
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] id The ID of the issue board.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about updated group issue board.
    ...
    #
    # @example
    #   Gitlab::Client.delete_group_board(5, 1)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] id The ID of the issue board.
    ...
    #
    # @example
    #   Gitlab::Client.group_board_lists(5, 1)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] board_id The ID of the group issue board.
    # @return [Array<Gitlab::Client::ObjectifiedHash>] List of boards lists of the group
    ...
    #
    # @example
    #   Gitlab::Client.group_board_list(5, 1, 1)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] board_id The ID of the group issue board.
    # @param  [Integer] list_id The ID of a boards list.
    # @return [Gitlab::Client::ObjectifiedHash] Returns information about a single group issue board list
    ...
    #
    # @example
    #   Gitlab::Client.create_group_board_list(5, 1)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] board_id The ID of the group issue board.
    # @param  [Integer] label_id The ID of a label.
    # @return [Gitlab::Client::ObjectifiedHash] Information about created group issue board list.
    ...
    #
    # @example
    #   Gitlab::Client.edit_group_board_list(5, 1, 1, { position: 1 })
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] board_id The ID of the group issue board.
    # @param  [Integer] list_id The ID of a boards list.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about updated group issue board list.
    ...
    #
    # @example
    #   Gitlab::Client.delete_group_board_list(5, 1, 1)
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [Integer] board_id The ID of the group issue board.
    # @param  [Integer] list_id The ID of a boards list.
