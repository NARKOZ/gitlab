...
class Gitlab::Client
  ...
  module BuildVariables
    ...
    #
    # @example
    #   Gitlab::Client.variables(5)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Client::ObjectifiedHash>] The list of variables.
    ...
    #
    # @example
    #   Gitlab::Client.variable(5, "TEST_VARIABLE_1")
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] key The key of a variable.
    # @return [Gitlab::Client::ObjectifiedHash] The variable.
    ...
    #
    # @example
    #   Gitlab::Client.create_variable(5, "NEW_VARIABLE", "new value")
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.update_variable(5, "NEW_VARIABLE", "updated value")
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] key The key of a variable
    # @param  [String] value The value of a variable
    ...
    #
    # @example
    #   Gitlab::Client.remove_variable(5, "VARIABLE_1")
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [String] key The key of a variable.
    # @param  [Hash] opts optional parameters
    ...
    #
    # @example
    #   Gitlab::Client.group_variables(5)
    #
    ...
    #
    # @example
    #   Gitlab::Client.group_variable(5, "TEST_VARIABLE_1")
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] key The key of a variable.
    # @return [Gitlab::Client::ObjectifiedHash] The variable.
    ...
    #
    # @example
    #   Gitlab::Client.create_group_variable(5, "NEW_VARIABLE", "new value")
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] key The key of a variable; must have no more than 255 characters; only `A-Z`, `a-z`, `0-9` and `_` are allowed
    # @param  [String] value The value of a variable
    ...
    #
    # @example
    #   Gitlab::Client.update_group_variable(5, "NEW_VARIABLE", "updated value")
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] key The key of a variable
    # @param  [String] value The value of a variable
    ...
    #
    # @example
    #   Gitlab::Client.remove_group_variable(5, "VARIABLE_1")
    #
    # @param  [Integer, String] group The ID or name of a group.
    # @param  [String] key The key of a variable.
    # @return [Gitlab::Client::ObjectifiedHash] The variable.
