...
class Gitlab::Client
  ...
  module MergeRequests
    ...
    #
    # @example
    #   Gitlab::Client.user_merge_requests
    #   Gitlab::Client.user_merge_requests(state: :opened, scope: :all)
    #
    ...
    #
    # @example
    #   Gitlab::Client.merge_requests(5)
    #   Gitlab::Client.merge_requests(5, { per_page: 40 })
    #
    ...
    #
    # @example
    #   Gitlab::Client.merge_request(5, 36)
    #   Gitlab::Client.merge_request(5, 36, { include_diverged_commits_count: true })
    #
    # @param  [Integer, String] project The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_pipelines(5, 36)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_participants(5, 36)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.create_merge_request(5, 'New merge request',
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about created merge request.
    ...
    #
    # @example
    #   Gitlab::Client.update_merge_request(5, 42, { title: 'New title' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about updated merge request.
    ...
    #
    # @example
    #   Gitlab::Client.accept_merge_request(5, 42, { merge_commit_message: 'Nice!' })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_changes(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Gitlab::Client::ObjectifiedHash] The merge request's changes.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_commits(5, 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Array<Gitlab::Client::ObjectifiedHash>] The merge request's commits.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_closes_issues(5, 1)
    #
    ...
    #
    # @example
    #   Gitlab::Client.subscribe_to_merge_request(5, 1)
    #   Gitlab::Client.subscribe_to_merge_request('gitlab', 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Gitlab::Client::ObjectifiedHash] Information about subscribed merge request.
    ...
    #
    # @example
    #   Gitlab::Client.unsubscribe_from_merge_request(5, 1)
    #   Gitlab::Client.unsubscribe_from_merge_request('gitlab', 1)
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Gitlab::Client::ObjectifiedHash] Information about unsubscribed merge request.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_discussions(5, 1)
    #   Gitlab::Client.merge_request_discussions('gitlab', 1)
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Gitlab::Client::ObjectifiedHash] List of the merge request discussions.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_discussion(5, 1, 1)
    #   Gitlab::Client.merge_request_discussion('gitlab', 1, 1)
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Integer] discussion_id The ID of a discussion.
    # @return [Gitlab::Client::ObjectifiedHash] The merge request discussion.
    ...
    #
    # @example
    #   Gitlab::Client.create_merge_request_discussion(5, 1, body: 'discuss')
    #   Gitlab::Client.create_merge_request_discussion('gitlab', 1, body: 'discuss')
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] The created merge request discussion.
    ...
    #
    # @example
    #   Gitlab::Client.resolve_merge_request_discussion(5, 1, 1, true)
    #   Gitlab::Client.resolve_merge_request_discussion('gitlab', 1, 1, false)
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Integer] discussion_id The ID of a discussion.
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Client.create_merge_request_discussion_note(5, 1, 1, note_id: 1, body: 'note')
    #   Gitlab::Client.create_merge_request_discussion_note('gitlab', 1, 1, note_id: 1, body: 'note')
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Integer] discussion_id The ID of a discussion.
    # @param  [Hash] options A customizable set of options.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] The merge request discussion note.
    ...
    #
    # @example
    #   Gitlab::Client.update_merge_request_discussion_note(5, 1, 1, 1, body: 'note')
    #   Gitlab::Client.update_merge_request_discussion_note('gitlab', 1, 1, 1, body: 'note')
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Integer] discussion_id The ID of a discussion.
    ...
    #
    # @example
    #   Gitlab::Client.delete_merge_request_discussion_note(5, 1, 1, 1)
    #   Gitlab::Client.delete_merge_request_discussion_note('gitlab', 1, 1, 1)
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Integer] discussion_id The ID of a discussion.
    # @param  [Integer] note_id The ID of a discussion note.
    # @return [Gitlab::Client::ObjectifiedHash] An empty response.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_versions(5, 1)
    #   Gitlab::Client.merge_request_versions('gitlab', 1)
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @return [Gitlab::Client::ObjectifiedHash] A list of the merge request versions.
    ...
    #
    # @example
    #   Gitlab::Client.merge_request_diff_version(5, 1, 1)
    #   Gitlab::Client.merge_request_diff_version('gitlab', 1, 1)
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Integer] id The ID of a merge request diff version.
    # @return [Gitlab::Client::ObjectifiedHash] Record of the specific diff
    ...
    #
    # @example
    #   Gitlab::Client.rebase_merge_request(5, 42, { skip_ci: true })
    #
    # @param  [Integer, String] project The ID or name of a project.
    # @param  [Integer] id The ID of a merge request.
    # @param  [Hash] options A customizable set of options.
    # @option options [String] :skip_ci Set to true to skip creating a CI pipeline
    # @return [Gitlab::Client::ObjectifiedHash] Rebase progress status
