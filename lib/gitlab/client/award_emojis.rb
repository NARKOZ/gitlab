...
class Gitlab::Client
  ...
  module AwardEmojis
    ...
    #
    # @example
    #   Gitlab::Client.award_emojis(1, 80, 'issue')
    #   Gitlab::Client.award_emojis(1, 60, 'merge_request')
    #   Gitlab::Client.award_emojis(1, 40, 'snippet')
    #
    ...
    #
    # @example
    #   Gitlab::Client.note_award_emojis(1, 80, 'issue', 1)
    #   Gitlab::Client.note_award_emojis(1, 60, 'merge_request', 1)
    #   Gitlab::Client.note_award_emojis(1, 40, 'snippet', 1)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Client.award_emoji(1, 80, 'issue', 4)
    #   Gitlab::Client.award_emoji(1, 60, 'merge_request', 4)
    #   Gitlab::Client.award_emoji(1, 40, 'snippet', 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Client.note_award_emoji(1, 80, 'issue', 1, 4)
    #   Gitlab::Client.note_award_emoji(1, 60, 'merge_request', 1, 4)
    #   Gitlab::Client.note_award_emoji(1, 40, 'snippet', 1, 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Client.create_award_emoji(1, 80, 'issue', 'blowfish')
    #   Gitlab::Client.create_award_emoji(1, 80, 'merge_request', 'blowfish')
    #   Gitlab::Client.create_award_emoji(1, 80, 'snippet', 'blowfish')
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Client.create_note_award_emoji(1, 80, 'issue', 1, 'blowfish')
    #   Gitlab::Client.create_note_award_emoji(1, 80, 'merge_request', 1, 'blowfish')
    #   Gitlab::Client.create_note_award_emoji(1, 80, 'snippet', 1, 'blowfish')
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Client.delete_award_emoji(1, 80, 'issue', 4)
    #   Gitlab::Client.delete_award_emoji(1, 60, 'merge_request', 4)
    #   Gitlab::Client.delete_award_emoji(1, 40, 'snippet', 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
    ...
    #
    # @example
    #   Gitlab::Client.delete_note_award_emoji(1, 80, 'issue', 1, 4)
    #   Gitlab::Client.delete_note_award_emoji(1, 60, 'merge_request', 1, 4)
    #   Gitlab::Client.delete_note_award_emoji(1, 40, 'snippet', 1, 4)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] awardable_id The ID of an awardable(issue, merge request or snippet).
    # @param [String] awardable_type The type of the awardable(can be 'issue', 'merge_request' or 'snippet')
