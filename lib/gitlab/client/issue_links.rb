...
class Gitlab::Client
  ...
  module IssueLinks
    ...
    #
    # @example
    #   Gitlab::Client.issue_links(5, 10)
    #
    ...
    #
    # @example
    #   Gitlab::Client.create_issue_link(6, 1, 6, 2)
    #
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about created link.
    ...
    #
    # @example
    #   Gitlab::Client.delete_issue_link(5, 10, 123)
    #
    # @param [Integer] project The ID of a project.
    # @param [Integer] issue The ID of an issue.
