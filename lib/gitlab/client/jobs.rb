...
class Gitlab::Client
  ...
  module Jobs
    ...
    #
    # @example
    #   Gitlab::Client.jobs(1)
    #   Gitlab::Client.jobs("project")
    #   Gitlab::Client.jobs("project", {scope: ["manual", "success"], per_page: 100 })
    #
    ...
    #
    # @example
    #   Gitlab::Client.pipeline_jobs(1, 2)
    #   Gitlab::Client.pipeline_jobs("project", 2)
    #
    ...
    #
    # @example
    #   Gitlab::Client.pipeline_bridges(1, 2)
    #   Gitlab::Client.pipeline_bridges("project", 2)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the pipeline
    # @param  [Hash] options A customizable set of options.
    ...
    #
    # @example
    #   Gitlab::Client.job(1, 2)
    #   Gitlab::Client.job("project", 2)
    #
    # @param  [Integer, String] The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.job_artifacts(1, 2)
    #   Gitlab::Client.job_artifacts("project", 2)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.job_artifacts_download(1, "master", "release")
    #   Gitlab::Client.job_artifacts_download("project", "master", "release")
    #
    ...
    #
    # @example
    #   Gitlab::Client.download_job_artifact_file(1, 5, "some/release/file.pdf")
    #
    ...
    #
    # @example
    #   Gitlab::Client.download_branch_artifact_file(1, "master", "some/release/file.pdf", 'pdf')
    #
    # @param  [Integer, String] project_id(required) The ID or name of a project.
    ...
    #
    # @example
    #   Gitlab::Client.job_trace(1,1)
    #   Gitlab::Client.job_trace("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.job_cancel(1,1)
    #   Gitlab::Client.job_cancel("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.job_retry(1,1)
    #   Gitlab::Client.job_retry("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.job_erase(1,1)
    #   Gitlab::Client.job_erase("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.job_play(1,1)
    #   Gitlab::Client.job_play("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.job_artifacts_keep(1,1)
    #   Gitlab::Client.job_artifacts_keep("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
    ...
    #
    # @example
    #   Gitlab::Client.job_artifacts_delete(1,1)
    #   Gitlab::Client.job_artifacts_delete("project", 1)
    #
    # @param  [Integer, String] The ID or name of a project.
    # @param  [Integer]  the id of the job
    # @return [Array<Gitlab::Client::ObjectifiedHash>]
