...
class Gitlab::Client
  ...
  module Epics
    ...
    #
    # @example
    #   Gitlab::Client.epics(123)
    #   Gitlab::Client.epics(123, { per_page: 40, page: 2 })
    #
    ...
    #
    # @example
    #   Gitlab::Client.create_epic(123, "My new epic title")
    #
    # @param  [Integer] group_id The ID of a group.
    # @param  [String] title
    # @param  [Hash] options A customizable set of options.
    # @return [Gitlab::Client::ObjectifiedHash] Information about created epic.
    ...
    #
    # @example
    #   Gitlab::Client.delete_epic(42, 123)
    # @param  [Integer] group_id The ID of a group.
    ...
    #
    # @example
    #   Gitlab::Client.edit_epic(42)
    #   Gitlab::Client.edit_epic(42, 123, { title: 'New epic title' })
    #
    # @param  [Integer] group_id The ID.
    # @param  [Integer] epic_iid The IID of an epic.
    # @param  [Hash] options A customizable set of options
    # @return [Gitlab::Client::ObjectifiedHash] Information about the edited epic.
