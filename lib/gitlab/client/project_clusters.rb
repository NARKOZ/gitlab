...
class Gitlab::Client
  ...
  module ProjectClusters
    ...
    #
    # @example
    #   Gitlab::Client.project_clusters(5)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @return [Array<Gitlab::Client::ObjectifiedHash>] List of all clusters of a project
    ...
    #
    # @example
    #   Gitlab::Client.project_cluster(5, 42)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] cluster_id  The ID of the cluster.
    # @return [Gitlab::Client::ObjectifiedHash] Information about the requested cluster
    ...
    #
    # @example
    #   Gitlab::Client.add_project_cluster(5, 'cluster-5', { enabled: false, platform_kubernetes_attributes: { api_url: 'https://35.111.51.20', token: '12345', ca_cert: "-----BEGIN CERTIFICATE-----\r\nhFiK1L61owwDQYJKoZIhvcNAQELBQAw\r\nLzEtMCsGA1UEAxMkZDA1YzQ1YjctNzdiMS00NDY0LThjNmEtMTQ0ZDJkZjM4ZDBj\r\nMB4XDTE4MTIyNzIwMDM1MVoXDTIzMTIyNjIxMDM1MVowLzEtMCsGA1UEAxMkZDA1\r\nYzQ1YjctNzdiMS00NDY0LThjNmEtMTQ0ZDJkZjM.......-----END CERTIFICATE-----", namespace: 'cluster-5-namespace', authorization_type: 'rbac' } })
    #   Gitlab::Client.add_project_cluster(5, 'cluster-5', { platform_kubernetes_attributes: { api_url: 'https://35.111.51.20', token: '12345' } })
    #
    # @param [Integer, String] project The ID or name of a project.
    ...
    # @return [Gitlab::Client::ObjectifiedHash] Information about the added project cluster.
    ...
    #
    # @example
    #   Gitlab::Client.edit_project_cluster(5, 1, { name: 'cluster-6', platform_kubernetes_attributes: { api_url: 'https://35.111.51.20', token: '12345', ca_cert: "-----BEGIN CERTIFICATE-----\r\nhFiK1L61owwDQYJKoZIhvcNAQELBQAw\r\nLzEtMCsGA1UEAxMkZDA1YzQ1YjctNzdiMS00NDY0LThjNmEtMTQ0ZDJkZjM4ZDBj\r\nMB4XDTE4MTIyNzIwMDM1MVoXDTIzMTIyNjIxMDM1MVowLzEtMCsGA1UEAxMkZDA1\r\nYzQ1YjctNzdiMS00NDY0LThjNmEtMTQ0ZDJkZjM.......-----END CERTIFICATE-----", namespace: 'cluster-6-namespace' } })
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] cluster_id  The ID of the cluster.
    # @param [Hash] options A customizable set of options.
    ...
    # @suboption platform_kubernetes_attributes [String] :ca_cert(optional)   TLS certificate (needed if API is using a self-signed TLS certificate
    # @suboption platform_kubernetes_attributes [String] :namespace(optional)   The unique namespace related to the project
    # @return [Gitlab::Client::ObjectifiedHash] Information about the updated project cluster.
    ...
    #
    # @example
    #   Gitlab::Client.delete_project_cluster(5, 42)
    #
    # @param [Integer, String] project The ID or name of a project.
    # @param [Integer] cluster_id The ID of the cluster.
